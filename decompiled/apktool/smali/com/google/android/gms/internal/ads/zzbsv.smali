...
.method public final zzdi(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-interface {p0, p1, p4, v0}, Lcom/google/android/gms/internal/ads/zzbsw;->zzH(I[Ljava/lang/String;[I)V
    ...
    :pswitch_1
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/zzbsw;->zzf()V
    ...
    invoke-interface {p0, p1}, Lcom/google/android/gms/internal/ads/zzbsw;->zzn(Lcom/multiaccounts/cloneapps/js;)V
    ...
    invoke-interface {p0, p1, p4, v0}, Lcom/google/android/gms/internal/ads/zzbsw;->zzm(IILandroid/content/Intent;)V

    goto :goto_0

    :pswitch_4
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/zzbsw;->zzg()Z
    ...
    :pswitch_5
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/zzbsw;->zze()V

    goto :goto_0

    :pswitch_6
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/zzbsw;->zzs()V

    goto :goto_0

    :pswitch_7
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/zzbsw;->zzq()V

    goto :goto_0

    :pswitch_8
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/zzbsw;->zzp()V
    ...
    invoke-interface {p0, p1}, Lcom/google/android/gms/internal/ads/zzbsw;->zzo(Landroid/os/Bundle;)V
    ...
    :pswitch_a
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/zzbsw;->zzl()V

    goto :goto_0

    :pswitch_b
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/zzbsw;->zzk()V

    goto :goto_0

    :pswitch_c
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/zzbsw;->zzj()V

    goto :goto_0

    :pswitch_d
    invoke-interface {p0}, Lcom/google/android/gms/internal/ads/zzbsw;->zzi()V
    ...
    invoke-interface {p0, p1}, Lcom/google/android/gms/internal/ads/zzbsw;->zzh(Landroid/os/Bundle;)V
